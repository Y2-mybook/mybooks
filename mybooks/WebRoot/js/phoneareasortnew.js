...
var LoginV1 = {
    ...
    weixinUnbanUrl   : '/login/weixinunban',
    ...
    init: function(params) {
        ...
        //除申诉解禁外检测是否登录
        if(LoginV1.config.type !=  'ywunban'){
        ...
        $('#sendPhoneMsg').on('click', function(e) {
            ...
            if (LoginV1.checkVerifyForm() && !LoginV1.validateShow) {
            ...
            if(LoginV1.validateShow){
                ...
                var slidePhoneSendMsgByCodeFun = function(retJson) {
                    ...
                    data.validateCode = ticket.randstr + ';'+ ticket.ticket;
  ...
  // 检查手机是否合法和是否已注册
    ...
    phoneSendMsgCallback: function(data) {
        ...
        LoginV1.sessionKey = data.data.data;
    ...
    phoneSendMsgByCodeCommon: function(sendMsgObj,data,areaId){
        ...
        if(data.validateCode == undefined || data.validateCode == null || !data.validateCode){
            LoginV1.showError('验证不正确，请重新验证');
            return false;
        }
    ...
    slidePhoneSendMsgByCode:function (obj,capName,callbackName) {
        ...
        if (LoginV1.config.getslidejs == 1) {
            ...
            $.getScript(url, function () {
                obj.show();
                //显示验证码
                var capOption = {callback: callbackName, type: "embed", firstvrytype: 1};
    ...
    slidePhoneSendMsgByCodeFunCallback: function (data) {
        LoginV1.slidePhoneSendMsgByCodeCommonCallback(data,$('#fast-send-dpw'));
    },

    slidePhoneSendMsgByCodeLoginCallback: function (data){
        LoginV1.slidePhoneSendMsgByCodeCommonCallback(data,$('#sendPhoneMsg'));
    },

    slidePhoneSendMsgByCodeCommonCallback: function (data,obj) {
        LoginV1.ajaxLock = false;
    ...
    weixinUnban: function() {
        if ($('#div_weixinlogin iframe').length > 0) {
            $('#div_weixinlogin iframe').show();
            return;
        }
        var url = LoginV1.config.baseUrl + LoginV1.weixinUnbanUrl + '?' + LoginV1.buildBaseDataString();
